...
#'
#' @description A shiny::selectInput wrapper around VariablesApi.search_variables_groups (\code{\link[opensilexClientToolsR:VariablesApi]{ search_variables_groups }})
#'
...
#' @param api_function_options List of options to pass to VariablesApi.search_variables_groups from opensilexClientToolsR package (\code{\link[opensilexClientToolsR:VariablesApi]{ search_variables_groups }})
...
#'  \item{options}{The options used to call VariablesApi.search_variables_groups }
#'  \item{selected}{The selection of the shiny::selectInput widget }
#'  \item{choices}{A named list containing the selection choices} 
#'  \item{result_df}{A dataframe containing the results of VariablesApi.search_variables_groups call}
#' }
