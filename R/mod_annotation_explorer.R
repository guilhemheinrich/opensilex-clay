...
#'
#' @description A shiny::selectInput wrapper around AnnotationsApi.search_annotations (\code{\link[opensilexClientToolsR:AnnotationsApi]{ search_annotations }})
#'
...
#' @param api_function_options List of options to pass to AnnotationsApi.search_annotations from opensilexClientToolsR package (\code{\link[opensilexClientToolsR:AnnotationsApi]{ search_annotations }})
...
#'  \item{options}{The options used to call AnnotationsApi.search_annotations }
#'  \item{selected}{The selection of the shiny::selectInput widget }
#'  \item{choices}{A named list containing the selection choices} 
#'  \item{result_df}{A dataframe containing the results of AnnotationsApi.search_annotations call}
#' }
