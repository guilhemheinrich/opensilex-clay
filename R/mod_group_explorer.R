...
#'
#' @description A shiny::selectInput wrapper around SecurityApi.search_groups (\code{\link[opensilexClientToolsR:SecurityApi]{ search_groups }})
#'
...
#' @param api_function_options List of options to pass to SecurityApi.search_groups from opensilexClientToolsR package (\code{\link[opensilexClientToolsR:SecurityApi]{ search_groups }})
...
#'  \item{options}{The options used to call SecurityApi.search_groups }
#'  \item{selected}{The selection of the shiny::selectInput widget }
#'  \item{choices}{A named list containing the selection choices} 
#'  \item{result_df}{A dataframe containing the results of SecurityApi.search_groups call}
#' }
