...
#'
#' @description A shiny::selectInput wrapper around FactorsApi.search_factor_levels (\code{\link[opensilexClientToolsR:FactorsApi]{ search_factor_levels }})
#'
...
#' @param api_function_options List of options to pass to FactorsApi.search_factor_levels from opensilexClientToolsR package (\code{\link[opensilexClientToolsR:FactorsApi]{ search_factor_levels }})
