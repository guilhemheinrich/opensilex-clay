...
#'
#' @description A shiny::selectInput wrapper around PositionsApi.search_position_history (\code{\link[opensilexClientToolsR:PositionsApi]{ search_position_history }})
#'
...
#' @param api_function_options List of options to pass to PositionsApi.search_position_history from opensilexClientToolsR package (\code{\link[opensilexClientToolsR:PositionsApi]{ search_position_history }})
...
#'  \item{options}{The options used to call PositionsApi.search_position_history }
#'  \item{selected}{The selection of the shiny::selectInput widget }
#'  \item{choices}{A named list containing the selection choices} 
#'  \item{result_df}{A dataframe containing the results of PositionsApi.search_position_history call}
#' }
